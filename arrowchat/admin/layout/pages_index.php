	...
	?>
      ...
      <div class="title_bg" id="content-recent"> 
		...
		?>
			...
			<div class="title_bg" id="content-blog" style="float: left; width: 350px;"> 
				<div class="title">ArrowChat Development Blog</div> 
				<div class="module_content" style="height:342px; overflow-y:auto;">
					<div id="rssLoading">Loading...</div>
					<div id="rssOutput" style="line-height: 16px; display: none;"></div>
				</div>
			</div>
			<div class="title_bg" id="content-blog" style="float: right; width: 350px;"> 
				<div class="title">ArrowChat Facebook Page</div> 
				<div class="module_content" style="padding: 0px;">
					<iframe src="http://www.facebook.com/connect/connect.php?name=ArrowChat&connections=6&stream=1&css=http://www.arrowchat.com/scripts/facebook.css?v4" width="350" height="362" scrolling="no" frameborder="0"></iframe>
				</div>
			</div>
			<div style="clear: both;"></div>