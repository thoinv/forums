...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="edit-user" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>&id=<?php echo get_var('id'); ?>" enctype="multipart/form-data">
...
?>
			...
			<div class="title_bg"> 
				...
				<div class="module_content">
					<form method="post" id="remove-ban" action="<?php echo $_SERVER['PHP_SELF']; ?>?do=<?php echo $do; ?>" enctype="multipart/form-data">
