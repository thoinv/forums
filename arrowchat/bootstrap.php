<?php
	...
	*/
	...
	if ($push_on == 1)
	{
		require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . "classes/class_pubnub.php");
		$pubnub = new Pubnub( $push_publish, $push_subscribe, $push_secret, false);
	}
