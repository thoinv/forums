<?php 
	...
	*/
	...
	define('DB_PASSWORD','<techlife>'); 
	define('DB_NAME','gam5a280_xenforo');	
	...
	*/
	...
	define('DB_USERTABLE_AVATAR','user_id'); 
	
	define('DB_FRIENDSTABLE','user_follow'); 
	define('DB_FRIENDSTABLE_USERID', 'user_id'); 
	define('DB_FRIENDSTABLE_FRIENDID', 'follow_user_id'); 
