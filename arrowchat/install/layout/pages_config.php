							...
							$(".int_button_label2").click(function() {
								if ($(".int_button_label").children("input[@type=radio]").is(":checked"))
								{
									...
									?>
										...
										$("#smart_polling").attr("checked", "checked");
										$("#smart_polling").parent().parent().css("border", "5px solid #017fd6");
									<?php
										}
									?>
								}
			...
			?>
				<form method="post" id="config_form" action="<?php echo $_SERVER['PHP_SELF']; ?>?mode=config">
					...
					<div class="buddy_list_setup">
						...
						?>
							<li class="int_button_li3" style="width:463px;">
								<div style="float: right; padding-top:17px; width: 250px; text-align: left; line-height:2.3em;">
									...
									1. Create an account <a href="https://pubnub-prod.appspot.com/register" target="_blank">here</a><br />
									2. Visit your account page<br />
									3. Enter the information at the bottom:
									...
									<div style="float: left; width: 140px; padding-left: 10px; padding-top: 5px;">
										<input type="text" class="step3_input" disabled="disabled" name="secret_key" value="<?php echo $_SESSION['secret_key']; ?>" style="font-size: 11px; height: 15px; width: 120px; position:static; left:0" />
									</div>
								</div>
						...
						?>
							<li class="int_button_li3" style="width:463px;">
								<label style="width:462px; height:229px; padding-top: 0px;">
									<a href="http://www.arrowchat.com/members/" target="_blank"><img src="./images/upgrade-to-business.png" border="0" style="width: 462px !important; height: 229px !important" alt="Upgrade to Business" /></a>
								</label>
							</li>
						<?php
							}
