				...
				<table class="form-table"> 
					...
					<tr class="no-border"> 
						...
						<th scope="row"><label for="cachewrite"><a href="javascript:;" class="vtip" title="The includes folder must be writable.  CHMOD it to 777.">Includes folder writable</a></label></th> 
						<td></td>
					</tr>  
				</table>