...
?>
			...
			<table class="form-table"> 
				<tr> 
					<td width="20"><img src="../public/debug/images/reserve_tab_<?php echo $test_userid_img; ?>.png" alt="" /></td> 
				...
				<tr> 
					<td width="20"><img src="../public/debug/images/reserve_tab_<?php echo $test_buddylist_img; ?>.png" alt="" /></td> 
				...
				<tr> 
					<td width="20"><img src="../public/debug/images/reserve_tab_<?php echo $test_banned_img; ?>.png" alt="" /></td> 
				...
				<tr> 
					<td width="20"><img src="../public/debug/images/reserve_tab_<?php echo $test_browser_img; ?>.png" alt="" /></td> 
				...
				<tr class="no-border"> 
					<td width="20"><img src="../public/debug/images/reserve_tab_<?php echo $integration_img; ?>.png" alt="" /></td> 
