...
include_once(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR.'system'.DIRECTORY_SEPARATOR.'conf_main.php';

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/* ADVANCED */

define('SET_SESSION_NAME',$C->RNDKEY.str_replace(array('.','-'), '', $C->DOMAIN));
...
function getAvatar($image) {
    if ($image && is_file(dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'i'.DIRECTORY_SEPARATOR.'avatars'.DIRECTORY_SEPARATOR.$image)) {
