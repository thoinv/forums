...
$db = parse_ini_file(dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR."application".DIRECTORY_SEPARATOR."configs".DIRECTORY_SEPARATOR."application.ini");

/* DATABASE */

define('DB_SERVER',					$db['resources.db.params.host']				);
define('DB_PORT',					'3306'										);
define('DB_USERNAME',				$db['resources.db.params.username']			);
define('DB_PASSWORD',				$db['resources.db.params.password']			);
define('DB_NAME',					$db['resources.db.params.dbname']			);
define('TABLE_PREFIX',				''											);
...
function getUserID() {
	...
	if (!empty($_SESSION['Zend_Auth']['storage']->id)) {
