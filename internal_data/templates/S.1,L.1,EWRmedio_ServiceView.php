...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8');
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8');
$__output .= '
';
$__extraData['pageDescription'] = array();
$__extraData['pageDescription']['content'] = '';
$__extraData['pageDescription']['content'] .= 'Media hosted on "' . htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8') . '" media streaming service.';
$__output .= '
...
$__extraData['head']['rss'] .= '
	...
	<link rel="alternate" type="application/rss+xml" title="' . 'RSS feed for ' . htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8') . '' . '" href="' . XenForo_Template_Helper_Core::link('full:media/service/rss', $service, array()) . '" />
';
$__output .= '

';
$__extraData['navigation'] = array();
$__extraData['navigation'][] = array('href' => XenForo_Template_Helper_Core::link('full:media/services', false, array()), 'value' => 'Services');
$__output .= '
...
' . XenForo_Template_Helper_Core::callHelper('pagenavhtml', array('public', htmlspecialchars($stop, ENT_QUOTES, 'UTF-8'), htmlspecialchars($count, ENT_QUOTES, 'UTF-8'), htmlspecialchars($start, ENT_QUOTES, 'UTF-8'), 'media/service', $service, array(), false, array())) . '
...
{
$__output .= '
				(<a href="' . XenForo_Template_Helper_Core::link('media/service/edit', $service, array()) . '">' . 'Edit' . '</a>)
			';
}
$__output .= '
		</div>
