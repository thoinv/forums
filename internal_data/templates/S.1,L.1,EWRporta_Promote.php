...
{
$__output .= '
			<li><label for="ctrl_attach"><input type="radio" name="promote_icon" value="attach" class="Disabler" id="ctrl_attach" ' . (($threadPromote['promote_icon'] == ('attach')) ? ' checked="checked"' : '') . ' /> ' . 'Attached Files' . ':</label>
