...
$__output .= '
						...
						<input type="hidden" name="item_name" value="' . 'Account Upgrade' . ': ' . htmlspecialchars($upgrade['title'], ENT_QUOTES, 'UTF-8') . ' (' . htmlspecialchars($visitor['username'], ENT_QUOTES, 'UTF-8') . ')" />
