...
<form action="' . XenForo_Template_Helper_Core::link('full:attachments/do-upload', false, array()) . '" method="post"
	...
	<dl class="ctrlUnit">
		<dt><label for="ctrl_upload">' . 'Upload a File' . ' (<span title="' . '' . XenForo_Template_Helper_Core::numberFormat($attachmentConstraints['size'], '0') . ' bytes' . '">' . 'Max ' . XenForo_Template_Helper_Core::numberFormat($attachmentConstraints['size'], 'size') . '' . '</span>):</label></dt>
	...
	<div class="attachmentConstraints pairsRows">
		<dl><dt>' . 'Accepted file types' . ':</dt> <dd>';
$i = 0;
