...
$__extraData['title'] = '';
$__extraData['title'] .= 'Delete Post by ' . htmlspecialchars($post['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
$__compilerVar5 .= '<dl class="ctrlUnit">
	...
	<dd><ul>
		<li>
			<label><input type="checkbox" name="send_author_alert" value="1" ' . (($__compilerVar4) ? ' checked="checked"' : '') . ' class="Disabler" id="ctrl_send_author_alert" /> ' . 'Notify author of this action.' . ' ' . 'Reason' . ':</label>
...
{
$__output .= '
		<h3 class="subHeading"><em>' . 'Note' . '</em>: ' . 'This is the first post in the thread. Deleting it will delete the whole thread.' . '</h3>
	';
}
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd>
			<input type="submit" value="' . 'Delete Post' . '" class="button primary" />
		</dd>
	</dl>
