...
$__extraData['title'] = '';
$__extraData['title'] .= 'Profile post for ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . '' . ' - ' . 'Report Profile Post';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Report Profile Post';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('profile-posts/report', $profilePost, array()) . '" method="post" class="xenForm formOverlay AutoValidator">
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Report Profile Post' . '" accesskey="s" class="button primary" /></dd>
	</dl>
