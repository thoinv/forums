...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($page['page_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Members Who Liked this Wiki';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Members Who Liked this Wiki';
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'Media' . ':</dt> <dd><a href="' . XenForo_Template_Helper_Core::link('wiki', $page, array()) . '">' . htmlspecialchars($page['page_name'], ENT_QUOTES, 'UTF-8') . '</a></dd></dl>
