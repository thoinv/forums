...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($keyword['keyword_text'], ENT_QUOTES, 'UTF-8');
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($keyword['keyword_text'], ENT_QUOTES, 'UTF-8');
$__output .= '
';
$__extraData['pageDescription'] = array();
$__extraData['pageDescription']['content'] = '';
$__extraData['pageDescription']['content'] .= 'Media tagged with "' . htmlspecialchars($keyword['keyword_text'], ENT_QUOTES, 'UTF-8') . '" by the original uploader or moderators.';
$__output .= '
...
$__extraData['head']['rss'] .= '
	...
	<link rel="alternate" type="application/rss+xml" title="' . 'RSS Feed For ' . htmlspecialchars($keyword['keyword_text'], ENT_QUOTES, 'UTF-8') . '' . '" href="' . XenForo_Template_Helper_Core::link('full:media/keyword/rss', $keyword, array()) . '" />
';
$__output .= '

';
$__extraData['navigation'] = array();
$__extraData['navigation'][] = array('href' => XenForo_Template_Helper_Core::link('full:media/keyword', false, array()), 'value' => 'Keywords');
$__output .= '
...
' . XenForo_Template_Helper_Core::callHelper('pagenavhtml', array('public', htmlspecialchars($stop, ENT_QUOTES, 'UTF-8'), htmlspecialchars($count, ENT_QUOTES, 'UTF-8'), htmlspecialchars($start, ENT_QUOTES, 'UTF-8'), 'media/keyword', $keyword, array(), false, array())) . '
