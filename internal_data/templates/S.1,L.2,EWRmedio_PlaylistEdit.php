...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($playlist['playlist_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($playlist['playlist_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
...
$__output .= '
				<dl class="ctrlUnit">
					<dt>
						<a class="button sortDelete">' . 'Xóa' . '</a>
