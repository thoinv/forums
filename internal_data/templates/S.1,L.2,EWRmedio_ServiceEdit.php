...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($service['service_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
...
<div class="sectionMain">
	<form action="' . XenForo_Template_Helper_Core::link('media/service/edit', $service, array()) . '" method="post" class="xenForm AutoValidator" data-redirect="true">
		...
		<fieldset>
			...
			<dl class="ctrlUnit">
				<dt><label for="ctrl_thumb">' . 'Hình thu nhỏ' . ': <span style="display: inline-block; width: 50px;">$thum =</span></label></dt>
			...
			<dl class="ctrlUnit">
				<dt><label for="ctrl_title">' . 'Tiêu đề' . ': <span style="display: inline-block; width: 50px;">$titl =</span></label></dt>
			...
			<dl class="ctrlUnit">
				<dt><label for="ctrl_keywords">' . 'Từ khóa' . ': <span style="display: inline-block; width: 50px;">$keyw =</span></label></dt>
		...
		<fieldset>
			<dl class="ctrlUnit">
				...
				<dd><select name="service_media" id="ctrl_media" class="textCtrl autoSize">
					...
					<option value="gallery" ' . (($service['service_media'] == ('gallery')) ? ('selected') : ('')) . '>' . 'Thư viện' . '</option>
				</select></dd>
			</dl>
		...
		<dl class="ctrlUnit submitUnit">
			...
			<dd>
				...
				<input type="submit" value="' . 'Lưu và Tải lại' . '" name="reload" class="button" />
			</dd>
		</dl>
