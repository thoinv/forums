...
'0' => $user,
'1' => 'subject'
)) . ' đã trả lời vào chủ đề ' . '<a href="' . XenForo_Template_Helper_Core::link('posts', $content, array()) . '" class="PopupItemLink">' . XenForo_Template_Helper_Core::callHelper('threadPrefix', array(
'0' => $content
)) . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . '</a>' . '. Có thể có bài viết thêm trong chủ đề.' . '
';
}
