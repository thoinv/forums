...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($title, ENT_QUOTES, 'UTF-8', (false)) . ' - ' . 'Chỉnh sửa lịch sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Chỉnh sửa lịch sửa';
$__output .= '
...
<form method="post" action="' . XenForo_Template_Helper_Core::link('edit-history', false, array()) . '" class="section">
	...
	<tr class="dataRow">
		<th class="old">' . 'Cũ' . '</th>
		<th class="new">' . 'Mới' . '</th>
		<th class="date">' . 'Ngày chỉnh sửa' . '</th>
		<th class="member">' . 'Thành viên' . '</th>
		<th class="viewVersion">&nbsp;</th>
	</tr>
	<tr class="dataRow">
		<td class="old">&nbsp;</td>
		<td class="new"><input type="radio" name="new" value="0" ' . (($newId == 0) ? ' checked="checked"' : '') . ' /></td>
		<td class="date dateCurrent">' . 'Phiên bản hiện tại' . '</td>
		<td class="member">&nbsp;</td>
...
'time' => htmlspecialchars($history['edit_date'], ENT_QUOTES, 'UTF-8')
			...
			<td class="dataOptions viewVersion"><a href="' . XenForo_Template_Helper_Core::link('edit-history/view', $history, array()) . '" class="secondaryContent OverlayTrigger">' . 'Xem chỉnh sửa trước của phiên bản' . '</a></td>
		</tr>
	';
}
$__output .= '
...
$__output .= '
	...
	<div class="sectionFooter"><input type="submit" value="' . 'So sánh các phiên bản' . '" class="button primary OverlayTrigger" /></div>
