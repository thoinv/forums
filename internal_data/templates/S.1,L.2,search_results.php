...
$__output .= '
	';
$__extraData['title'] = '';
$__extraData['title'] .= 'Kết quả tìm kiếm cho từ khóa' . ': ' . htmlspecialchars($search['search_query'], ENT_QUOTES, 'UTF-8');
$__output .= '
	';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Kết quả tìm kiếm cho từ khóa' . ': <a href="' . XenForo_Template_Helper_Core::link('search', $search, array(
'searchform' => '1'
...
$__output .= '
	';
$__extraData['title'] = '';
$__extraData['title'] .= 'Kết quả tìm kiếm';
$__output .= '
';
}
$__output .= '
