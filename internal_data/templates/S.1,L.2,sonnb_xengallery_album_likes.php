...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Members Who Liked The Album: ' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Members Who Liked The Album: ' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
