...
$__extraData['title'] = '';
$__extraData['title'] .= 'Add New Photos';
$__output .= '
...
<div class="section">
	<ul class="addPhotoSelect blockLinksList secondaryContent">
		<li>
			<a class="OverlayTrigger" href="' . XenForo_Template_Helper_Core::link('gallery/photos/album-select', false, array()) . '">' . 'Add to an existing album' . '</a>
		</li>
		<li>
			<a href="' . XenForo_Template_Helper_Core::link('gallery/photos/add', false, array()) . '">' . 'Add to default album' . '</a>
		</li>
		<li>
