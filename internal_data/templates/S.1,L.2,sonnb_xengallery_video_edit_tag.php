...
$__extraData['title'] = '';
$__extraData['title'] .= 'Edit video' . ': ' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8');
$__output .= '
...
';
$__compilerVar2 = '';
$__compilerVar2 .= '<form action="' . XenForo_Template_Helper_Core::link('gallery/videos/tag', $content, array()) . '" method="post"
