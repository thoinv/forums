...
$__extraData['title'] = '';
$__extraData['title'] .= 'Xóa chủ đề' . ': ' . XenForo_Template_Helper_Core::callHelper('threadPrefix', array(
'0' => $thread,
'1' => 'escaped'
...
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Xóa chủ đề' . ': ' . XenForo_Template_Helper_Core::callHelper('threadPrefix', array(
'0' => $thread
)) . htmlspecialchars($thread['title'], ENT_QUOTES, 'UTF-8');
$__output .= '
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Xóa chủ đề' . '" class="button primary" /></dd>
	</dl>
