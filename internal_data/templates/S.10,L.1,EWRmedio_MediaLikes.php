...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($media['media_title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Members Who Liked this Media';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Members Who Liked this Media';
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'Media' . ':</dt> <dd><a href="' . XenForo_Template_Helper_Core::link('media', $media, array()) . '">' . htmlspecialchars($media['media_title'], ENT_QUOTES, 'UTF-8') . '</a></dd></dl>
