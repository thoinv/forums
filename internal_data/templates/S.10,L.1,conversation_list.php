...
{
$__compilerVar2 .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/starred', false, array()) . '"><span class="starred" title="' . 'Starred' . '">' . 'Starred' . '</span></a>';
}
$__compilerVar2 .= '
				';
...
if ($visitor['user_id'])
{
$__compilerVar1 .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/toggle-read', $conversation, array()) . '" class="ReadToggle"
...
{
$__compilerVar1 .= XenForo_Template_Helper_Core::callHelper('usernamehtml', array($recipient,(($recipient['user_id']) ? (htmlspecialchars($recipient['username'], ENT_QUOTES, 'UTF-8')) : ('Unknown Member')),false,array())) . ',';
}
$__compilerVar1 .= '
					';
}
...
$__compilerVar3 = '';
$__compilerVar4 = '';
$__compilerVar4 .= 'Conversation Management';
$__compilerVar5 = '';
$__compilerVar5 .= '
	...
	';
$__compilerVar6 = '';
$__compilerVar6 .= 'Select / deselect all conversations on this page';
$__compilerVar7 = '';
$__compilerVar7 .= 'Selected Conversations';
$__compilerVar8 = '';
...
<span id="InlineModControls">
	<span class="selectionControl secondaryContent">
		<label for="ModerationCheck">
			' . 'Select All' . ' <input type="checkbox" id="ModerationCheck" title="' . htmlspecialchars($__compilerVar6, ENT_QUOTES, 'UTF-8') . '" />
		</label>
		...
		<a class="SelectionCount">' . htmlspecialchars($__compilerVar7, ENT_QUOTES, 'UTF-8') . ': <em class="InlineModCheckedTotal">0</em></a>
	</span>
...
{
$__compilerVar8 .= '<input type="submit" class="button" value="' . 'Delete' . '..." name="delete" />';
}
$__compilerVar8 .= '
			';
if ($inlineModOptions['approve'])
{
$__compilerVar8 .= '<input type="submit" class="button" value="' . 'Approve' . '" name="approve" />';
}
$__compilerVar8 .= '
		</span>
...
unset($__compilerVar4, $__compilerVar5, $__compilerVar6, $__compilerVar7, $__compilerVar8);
