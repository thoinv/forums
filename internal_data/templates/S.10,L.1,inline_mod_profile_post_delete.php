...
$__extraData['title'] = '';
$__extraData['title'] .= 'Inline Moderation - Delete Profile Posts';
$__output .= '

<form action="' . XenForo_Template_Helper_Core::link('inline-mod/profile-post/delete', false, array()) . '" method="post" class="xenForm formOverlay">
	<p>' . 'Are you sure you want to delete ' . htmlspecialchars($profilePostCount, ENT_QUOTES, 'UTF-8') . ' profile post(s)?' . '</p>
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" name="save" value="' . 'Delete Profile Posts' . '" accesskey="s" class="button primary" /></dd>
	</dl>
...
{
$__output .= '
		<input type="hidden" name="profilePosts[]" value="' . htmlspecialchars($profilePostId, ENT_QUOTES, 'UTF-8') . '" />
	';
}
$__output .= '
