...
$__extraData['title'] = '';
$__extraData['title'] .= 'Members ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' is Following';
$__output .= '
...
if ($hasMore)
{
$__output .= '<a class="button OverlayCloser OverlayTrigger" href="' . XenForo_Template_Helper_Core::link('members/following', $user, array(
'page' => ($page + 1)
)) . '">' . 'More' . '...</a>';
}
$__output .= '
...
{
$__output .= '
			' . '' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' does not follow anyone.' . '
		';
}
$__output .= '
	</div>
