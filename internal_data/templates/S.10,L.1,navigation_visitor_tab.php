...
<ul class="visitorTabs">
	...
	';
$__compilerVar1 = '';
$__output .= $this->callTemplateHook('navigation_visitor_tabs_start', $__compilerVar1, array());
...
{
$__output .= '<div class="muted">' . $__compilerVar2 . '</div>';
}
...
if ($canEditProfile)
{
$__compilerVar3 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/personal-details', false, array()) . '">' . 'Personal Details' . '</a></li>';
}
$__compilerVar3 .= '
					';
if ($canEditSignature)
{
$__compilerVar3 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/signature', false, array()) . '">' . 'Signature' . '</a></li>';
}
$__compilerVar3 .= '
...
if ($canUploadAvatar)
{
$__compilerVar3 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/avatar', false, array()) . '" class="OverlayTrigger" data-cacheOverlay="true">' . 'Avatar' . '</a></li>';
}
$__compilerVar3 .= '
					';
if ($xenOptions['facebookAppId'] OR $xenOptions['twitterAppKey'] OR $xenOptions['googleClientId'])
{
$__compilerVar3 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/external-accounts', false, array()) . '">' . 'External Accounts' . '</a></li>';
}
$__compilerVar3 .= '
					<li><a href="' . XenForo_Template_Helper_Core::link('account/security', false, array()) . '">' . 'Password' . '</a></li>
				';
$__output .= $this->callTemplateHook('navigation_visitor_tab_links1', $__compilerVar3, array());
...
{
$__compilerVar4 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/news-feed', false, array()) . '">' . 'Your News Feed' . '</a></li>';
}
$__compilerVar4 .= '
...
{
$__compilerVar4 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/upgrades', false, array()) . '">' . 'Account Upgrades' . '</a></li>';
}
$__compilerVar4 .= '
';
...
$__compilerVar4 .= '
				';
$__output .= $this->callTemplateHook('navigation_visitor_tab_links2', $__compilerVar4, array());
...
if ($xenOptions['enableNewsFeed'])
{
$__compilerVar5 .= '<li><a href="' . XenForo_Template_Helper_Core::link('account/news-feed', false, array()) . '">' . 'Your News Feed' . '</a></li>';
}
$__compilerVar5 .= '
				<li><a href="' . XenForo_Template_Helper_Core::link('account/likes', false, array()) . '">' . 'Likes You\'ve Received' . '</a></li>
			';
$__output .= $this->callTemplateHook('navigation_tabs_account', $__compilerVar5, array());
...
{
$__output .= '<a href="' . XenForo_Template_Helper_Core::link('conversations/add', false, array()) . '" class="floatLink">' . 'Start a New Conversation' . '</a>';
}
$__output .= '
...
$__output .= '
	...
	';
$__compilerVar6 = '';
$__output .= $this->callTemplateHook('navigation_visitor_tabs_middle', $__compilerVar6, array());
...
$__output .= '
	...
	';
$__compilerVar7 = '';
$__output .= $this->callTemplateHook('navigation_visitor_tabs_end', $__compilerVar7, array());
