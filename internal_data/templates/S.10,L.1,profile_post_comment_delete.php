...
$__extraData['title'] = '';
$__extraData['title'] .= 'Delete Profile Post Comment by ' . htmlspecialchars($comment['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
'comment' => $comment['profile_post_comment_id']
	...
	<dl class="ctrlUnit submitUnit">
		...
		<dd>
			...
			<input type="reset" value="' . 'Close' . '" class="button OverlayCloser overlayOnly" />
		</dd>
	</dl>
