...
)) . '" class="callToAction"><span>' . 'Add Resource' . '</span></a>';
$__output .= '
';
}
$__output .= '
...
$__output .= '
	...
	';
$__compilerVar5 = 'resources/categories';
$__compilerVar6 = $category;
$__compilerVar7 = '';
$__compilerVar8 = '';
$__compilerVar8 .= '
		';
...
$__compilerVar8 .= '
			<dt>' . 'Prefix' . ':</dt>
			<dd><a href="' . XenForo_Template_Helper_Core::link(htmlspecialchars($__compilerVar5, ENT_QUOTES, 'UTF-8'), $__compilerVar6, array(
...
$__output .= '
				';
$__compilerVar9 = (($resource['prefix_id']) ? (XenForo_Template_Helper_Core::link('resources/categories', $category, array(
'_params' => $pageNavParams,
...
if ($resource['prefix_id'] AND $__compilerVar9)
{
$__compilerVar10 .= '<a href="' . $__compilerVar9 . '" class="prefixLink" title="' . 'Show only resources prefixed by \'' . XenForo_Template_Helper_Core::callHelper('resourcePrefix', array(
'0' => $resource,
'1' => 'escaped',
'2' => ''
