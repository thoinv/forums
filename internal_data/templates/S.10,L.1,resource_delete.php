...
<form action="' . XenForo_Template_Helper_Core::link('resources/delete', $resource, array()) . '" method="post" class="xenForm formOverlay">
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Delete Resource' . '" class="button primary" /></dd>
	</dl>
