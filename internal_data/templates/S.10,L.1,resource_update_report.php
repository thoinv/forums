...
'0' => $resource,
'1' => 'escaped'
)) . htmlspecialchars($resource['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Report Resource Update';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Report Resource Update';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('resources/report-update', $resource, array(
'resource_update_id' => $update['resource_update_id']
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Report Resource Update' . '" accesskey="s" class="button primary" /></dd>
	</dl>
