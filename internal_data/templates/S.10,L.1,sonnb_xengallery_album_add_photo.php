...
<dl class="ctrlUnit">
	...
	<dd>
		...
		<input type="text" name="' . htmlspecialchars($__compilerVar1, ENT_QUOTES, 'UTF-8') . '_allow_view_username" value="" id="ctrl_' . htmlspecialchars($__compilerVar1, ENT_QUOTES, 'UTF-8') . '_allow_view_username" class="textCtrl xenGalleryCtrl AutoComplete" ' . (($photoPrivacy['allow_view'] != ('custom')) ? ('style="display:none;"') : ('')) . ' />			
...
<dl class="ctrlUnit">
	...
	<dd>
		...
		<input type="text" name="' . htmlspecialchars($__compilerVar1, ENT_QUOTES, 'UTF-8') . '_allow_comment_username" value="" id="ctrl_' . htmlspecialchars($__compilerVar1, ENT_QUOTES, 'UTF-8') . '_allow_comment_username" class="textCtrl xenGalleryCtrl AutoComplete" ' . (($photoPrivacy['allow_comment'] != ('custom')) ? ('style="display:none;"') : ('')) . ' />	
