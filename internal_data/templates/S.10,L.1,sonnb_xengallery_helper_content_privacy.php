...
<dl class="ctrlUnit">
	...
	<dd>
		...
		<p class="explain xenGalleryCtrl" ' . (($contentPrivacy['allow_view'] != ('custom')) ? ('style="display:none;"') : ('')) . '>' . 'Separate names with a comma.' . '</p>
	</dd>
</dl>
<dl class="ctrlUnit">
	...
	<dd>
		...
		<p class="explain xenGalleryCtrl" ' . (($contentPrivacy['allow_comment'] != ('custom')) ? ('style="display:none;"') : ('')) . '>' . 'Separate names with a comma.' . '</p>
	</dd>
</dl>';
