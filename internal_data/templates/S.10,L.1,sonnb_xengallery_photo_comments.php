...
$__extraData['title'] = '';
$__extraData['title'] .= 'Comments on photo id ' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . ' in the album "' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '" created by ' . htmlspecialchars($content['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
