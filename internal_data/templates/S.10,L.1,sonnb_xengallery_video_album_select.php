...
{
$__output .= '
						<option value="' . htmlspecialchars($album['album_id'], ENT_QUOTES, 'UTF-8') . '" data-href="' . XenForo_Template_Helper_Core::link('gallery/albums/add-video', $album, array()) . '">' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '</option>
					';
}
$__output .= '
				</select>
