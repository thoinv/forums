...
$__extraData['title'] = '';
$__extraData['title'] .= 'Members ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' is friends with';
$__output .= '
...
'0' => $friend
				...
				<dl class="userStats pairsInline">
					<dt title="' . 'Total messages posted by ' . htmlspecialchars($friend['username'], ENT_QUOTES, 'UTF-8') . '' . '">' . 'Messages' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($friend['message_count'], '0') . '</dd>
					<dt title="' . 'Number of times something posted by ' . htmlspecialchars($friend['username'], ENT_QUOTES, 'UTF-8') . ' has been \'liked\'' . '">' . 'Likes Received' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($friend['like_count'], '0') . '</dd>
					<dt>' . 'Trophy Points' . ':</dt> <dd title="' . 'Trophy Points' . '">' . XenForo_Template_Helper_Core::numberFormat($friend['trophy_points'], '0') . '</dd>
				</dl>
			</div>
			';
...
{
$__output .= '
	<div class="primaryContent">' . '' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' is not friends with anyone.' . '</div>
	<div class="sectionFooter overlayOnly"><a class="button primary OverlayCloser">' . 'Close' . '</a></div>
';
}
$__output .= '
