...
$__output .= '
        	<form action="LINK_MEMBER_POST_VISITOR" method="post" class="statusPoster AutoValidator" data-optInOut="OptIn">
        		<textarea name="message" class="textCtrl StatusEditor Elastic" placeholder="' . 'Update your status' . '..." rows="1" cols="40" style="height:14px" data-statusEditorCounter="#visMenuSEdCount-' . htmlspecialchars($widget['widget_id'], ENT_QUOTES, 'UTF-8') . '" data-nofocus="true"></textarea>
        		<div class="submitUnit">
        			<span id="visMenuSEdCount-' . htmlspecialchars($widget['widget_id'], ENT_QUOTES, 'UTF-8') . '" title="' . 'Characters remaining' . '"></span>
