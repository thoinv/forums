...
$__extraData['title'] = '';
$__extraData['title'] .= 'IP address information for comment by ' . htmlspecialchars($comment['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
<div class="section">
	<h3 class="subHeading">' . 'Media' . ': ' . htmlspecialchars($media['media_title'], ENT_QUOTES, 'UTF-8') . '</h3>
	';
$__compilerVar2 = '';
