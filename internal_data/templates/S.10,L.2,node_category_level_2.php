...
$__output .= '
			...
			<div class="nodeStats pairsInline">
				<dl><dt>' . 'Đề tài thảo luận' . ':</dt> <dd>' . (($category['privateInfo']) ? ('&ndash;') : (XenForo_Template_Helper_Core::numberFormat($category['discussion_count'], '0'))) . '</dd></dl>
				<dl><dt>' . 'Bài viết' . ':</dt> <dd>' . (($category['privateInfo']) ? ('&ndash;') : (XenForo_Template_Helper_Core::numberFormat($category['message_count'], '0'))) . '</dd></dl>
				';
if ($renderedChildren AND XenForo_Template_Helper_Core::styleProperty('nodeListSubForumPopup'))
{
$__output .= '
					<div class="Popup subForumsPopup">
						<a href="' . XenForo_Template_Helper_Core::link('categories', $category, array()) . '" rel="Menu" class="cloaked" data-closemenu="true"><span class="dt">' . 'Diễn đàn con' . ':</span> ' . XenForo_Template_Helper_Core::numberFormat($category['childCount'], '0') . '</a>
...
{
$__output .= '
				<span class="lastThreadTitle"><span>' . 'Mới nhất' . ':</span> <a href="' . XenForo_Template_Helper_Core::link('posts', $category['lastPost'], array()) . '" title="' . htmlspecialchars($category['lastPost']['title'], ENT_QUOTES, 'UTF-8') . '">' . htmlspecialchars($category['lastPost']['title'], ENT_QUOTES, 'UTF-8') . '</a></span>
