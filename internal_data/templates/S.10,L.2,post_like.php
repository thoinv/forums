...
'0' => $thread,
'1' => 'escaped'
)) . htmlspecialchars($thread['title'], ENT_QUOTES, 'UTF-8') . ' - ' . (($like) ? ('Unlike Post') : ('Thích bài viết'));
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= (($like) ? ('Unlike Post') : ('Thích bài viết'));
$__output .= '
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . (($like) ? ('Unlike Post') : ('Thích bài viết')) . '" accesskey="s" class="button primary" autofocus="true" /></dd>
	</dl>
