...
$__extraData['title'] = '';
$__extraData['title'] .= 'Sửa tin nhắn hồ sơ bởi ' . htmlspecialchars($profilePost['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
{
$__output .= '
				<a href="' . XenForo_Template_Helper_Core::link('profile-posts/delete', $profilePost, array()) . '" class="button OverlayTrigger">' . 'Xóa bài viết' . '...</a>
			';
}
$__output .= '
		</dd>
