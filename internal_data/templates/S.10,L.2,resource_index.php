...
)) . '" class="callToAction OverlayTrigger"><span>' . 'Thêm tài nguyên' . '</span></a>';
$__output .= '
';
}
$__output .= '
...
$__compilerVar27 .= '
			<dt>' . 'Tiền tố' . ':</dt>
			<dd><a href="' . XenForo_Template_Helper_Core::link(htmlspecialchars($__compilerVar24, ENT_QUOTES, 'UTF-8'), $__compilerVar25, array(
...
unset($__compilerVar24, $__compilerVar25, $__compilerVar26);
$__output .= '
...
$__output .= '
				';
$__compilerVar28 = (($resource['prefix_id']) ? (XenForo_Template_Helper_Core::link('resources', '', array(
'_params' => $pageNavParams,
...
if ($resource['prefix_id'] AND $__compilerVar28)
{
$__compilerVar30 .= '<a href="' . $__compilerVar28 . '" class="prefixLink" title="' . 'Show only resources prefixed by \'' . XenForo_Template_Helper_Core::callHelper('resourcePrefix', array(
'0' => $resource,
'1' => 'escaped',
'2' => ''
