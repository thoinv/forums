...
<dl class="ctrlUnit">
	...
	<dd>
		...
		<input type="text" name="' . htmlspecialchars($__compilerVar10, ENT_QUOTES, 'UTF-8') . '_allow_view_username" value="" id="ctrl_' . htmlspecialchars($__compilerVar10, ENT_QUOTES, 'UTF-8') . '_allow_view_username" class="textCtrl xenGalleryCtrl AutoComplete" ' . (($videoPrivacy['allow_view'] != ('custom')) ? ('style="display:none;"') : ('')) . ' />			
...
<dl class="ctrlUnit">
	...
	<dd>
		...
		<input type="text" name="' . htmlspecialchars($__compilerVar10, ENT_QUOTES, 'UTF-8') . '_allow_comment_username" value="" id="ctrl_' . htmlspecialchars($__compilerVar10, ENT_QUOTES, 'UTF-8') . '_allow_comment_username" class="textCtrl xenGalleryCtrl AutoComplete" ' . (($videoPrivacy['allow_comment'] != ('custom')) ? ('style="display:none;"') : ('')) . ' />	
...
$__output .= '</dd>
	...
	<dl class="ctrlUnit submitUnit">
		...
		<dd>
			...
			';
$__compilerVar17 = '';
$__compilerVar17 .= '<input type="button" value="' . 'Embed Videos' . '"
