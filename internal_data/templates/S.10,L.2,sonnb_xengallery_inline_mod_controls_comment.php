...
$__compilerVar8 = '';
$__compilerVar8 .= 'InlineModControlsComment';
$__compilerVar9 = '';
$__compilerVar9 .= 'ModerationSelectComment';
$__compilerVar10 = '';
$__compilerVar10 .= 'Comment Moderation';
$__compilerVar11 = '';
$__compilerVar11 .= '
		';
if ($inlineModOptions['delete'])
{
$__compilerVar11 .= '<option value="delete">' . 'Delete Comments' . '...</option>';
}
$__compilerVar11 .= '
		';
if ($inlineModOptions['undelete'])
{
$__compilerVar11 .= '<option value="undelete">' . 'Undelete Comments' . '</option>';
}
$__compilerVar11 .= '
		';
if ($inlineModOptions['approve'])
{
$__compilerVar11 .= '<option value="approve">' . 'Approve Comments' . '</option>';
}
$__compilerVar11 .= '
		';
if ($inlineModOptions['unapprove'])
{
$__compilerVar11 .= '<option value="unapprove">' . 'Unapprove Comments' . '</option>';
}
$__compilerVar11 .= '
		<option value="deselect">' . 'Deselect Comments' . '</option>
	';
$__compilerVar12 = '';
$__compilerVar12 .= 'Select / Deselect all loaded comments.';
$__compilerVar13 = '';
$__compilerVar13 .= 'Select comments';
$__compilerVar14 = '';
