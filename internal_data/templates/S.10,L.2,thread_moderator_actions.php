...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($thread['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Hoạt động điều phối viên';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Hoạt động điều phối viên';
$__output .= '
...
'time' => htmlspecialchars($entry['log_date'], ENT_QUOTES, 'UTF-8')
					...
					<td class="dataOptions"><a href="' . htmlspecialchars($entry['content_url'], ENT_QUOTES, 'UTF-8') . '" class="secondaryContent">' . 'Xem' . '</a></td>
				</tr>
			';
}
$__output .= '
...
{
$__output .= '
		<div class="primaryContent">' . 'Không có hoạt động nào của của điều phối viên đã được đăng' . '</div>
	';
}
$__output .= '
</div>';
