...
{
$__output .= '
					<a href="' . XenForo_Template_Helper_Core::link('threads/unread', $thread, array()) . '" title="' . 'Đến bài đầu tiên chưa đọc' . '">' . XenForo_Template_Helper_Core::callHelper('wrap', array(
'0' => $thread['title'],
'1' => '50'
)) . '</a>
				';
...
$__output .= '
	...
	<div class="listBlock stats pairsJustified">
		<dl class="major"><dt>' . 'Trả lời' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($thread['reply_count'], '0') . '</dd></dl>
		<dl class="minor"><dt>' . 'Đọc' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($thread['view_count'], '0') . '</dd></dl>
	</div>
