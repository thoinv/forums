...
$__extraData['title'] = '';
$__extraData['title'] .= 'Delete Comment By ' . htmlspecialchars($comment['username'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('media/comment/delete', $comment, array()) . '" method="post" class="xenForm formOverlay">
