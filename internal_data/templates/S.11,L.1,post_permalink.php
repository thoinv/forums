...
<form class="section permalinkInfo">
	...
	<h3 class="subHeading">' . 'Thread' . ': <a href="' . XenForo_Template_Helper_Core::link('threads/post-permalink', $thread, array(
'post' => $post
...
$__compilerVar2 .= '
					';
$__compilerVar3 = '';
$__compilerVar3 .= XenForo_Template_Helper_Core::link('full:threads/post-permalink', $thread, array(
'post' => $post
));
$__compilerVar4 = '';
