...
'0' => $report
					...
					<dl class="userStats pairsInline">
						<dt title="' . 'Total messages posted by ' . htmlspecialchars($report['username'], ENT_QUOTES, 'UTF-8') . '' . '">' . 'Messages' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($report['message_count'], '0') . '</dd>
						<dt title="' . 'Number of times something posted by ' . htmlspecialchars($report['username'], ENT_QUOTES, 'UTF-8') . ' has been \'liked\'' . '">' . 'Likes Received' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($report['like_count'], '0') . '</dd>
						<dt>' . 'Trophy Points' . ':</dt> <dd title="' . 'Trophy Points' . '">' . XenForo_Template_Helper_Core::numberFormat($report['trophy_points'], '0') . '</dd>
					</dl>
				</div>	
			';
}
...
{
$__output .= '
						<span class="reportCommentNote">' . 'Your comment will re-open this report.' . '</span>
...
'time' => htmlspecialchars($report['first_report_date'], ENT_QUOTES, 'UTF-8')
				...
				<dl><dt>' . 'Reports' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($report['report_count'], '0') . '</dd></dl>
				<dl><dt>' . 'Comments' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($report['comment_count'], '0') . '</dd></dl>
...
$__extraData['sidebar'] .= '
				<dl><dt>' . 'Last Modified' . ':</dt> <dd>' . XenForo_Template_Helper_Core::callHelper('datetimehtml', array($report['last_modified_date'],array(
...
$__extraData['sidebar'] .= '
									<li><label><input type="radio" name="report_state" value="resolved" /> ' . 'Resolved' . '</label></li>
									<li><label><input type="radio" name="report_state" value="rejected" /> ' . 'Rejected' . '</label></li>
								</ul>
