...
$__extraData['head']['openGraph'] .= '
	';
$__compilerVar1 = '';
$__compilerVar1 .= XenForo_Template_Helper_Core::link('canonical:gallery/categories', false, array());
$__compilerVar2 = '';
$__compilerVar2 .= 'Categories';
$__compilerVar3 = '';
...
';
$__compilerVar7 = '';
$__output .= $this->callTemplateHook('gallery_ad_category_index_above_category_list', $__compilerVar7, array());
...
';
$__compilerVar9 = '';
$__compilerVar9 .= XenForo_Template_Helper_Core::link('canonical:gallery/categories', false, array());
$__compilerVar10 = '';
$__compilerVar11 = '';
$__compilerVar11 .= '
			';
...
$__compilerVar12 .= '
					<fb:like href="' . htmlspecialchars($__compilerVar9, ENT_QUOTES, 'UTF-8') . '" show_faces="true" width="400" action="' . htmlspecialchars($xenOptions['facebookLikeAction'], ENT_QUOTES, 'UTF-8') . '" font="trebuchet ms" colorscheme="' . XenForo_Template_Helper_Core::styleProperty('fbColorScheme') . '"></fb:like>
				</div>
			';
}
$__compilerVar12 .= '
			';
$__compilerVar11 .= $this->callTemplateHook('share_page_options', $__compilerVar12, array());
