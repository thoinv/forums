...
';
if ($content['newPhotos'])
{
$__output .= '
	';
foreach ($content['newPhotos'] AS $content)
{
$__output .= '
		<a href="' . XenForo_Template_Helper_Core::link('gallery/photos', $content, array()) . '" class="attachedImages thumbnail">
...
'0' => $content['description'],
'1' => '100'
)) . '" src="' . htmlspecialchars($content['thumbnailSmall'], ENT_QUOTES, 'UTF-8') . '" style="max-height: 120px;" alt="" />
		</a>
	';
}
$__output .= '
