...
<ul id="map_legend"> 
	<li><img src="js/digitalpoint/pins/red.png" alt="' . 'staff' . '" />' . 'Staff Members' . '</li>
	<li><img src="js/digitalpoint/pins/green.png" alt="' . 'Registered Members' . '" />' . 'Registered Members' . '</li>
	<li><img src="js/digitalpoint/pins/orange.png" alt="' . 'Guest' . '" />' . 'Guest' . '</li>
	<li><img src="js/digitalpoint/pins/white.png" alt="' . 'Spider' . '" />' . 'Spider' . '</li>
	<li style="font-weight:normal">' . 'View' . ': <select id="move_and_zoom"><option value="">' . 'World' . '<option value="usa">' . 'United States' . '<option value="europe">' . 'Europe' . '<option value="india">' . 'India' . '<option value="oceania">' . 'Oceania' . '<option value="me">' . 'Show Yourself' . '</select></li>
</ul>
