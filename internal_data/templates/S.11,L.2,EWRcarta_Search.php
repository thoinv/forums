...
$__extraData['title'] = '';
$__extraData['title'] .= 'Kết quả tìm kiếm cho từ khóa' . ': ' . htmlspecialchars($keywords, ENT_QUOTES, 'UTF-8');
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Kết quả tìm kiếm cho từ khóa' . ': <em>' . htmlspecialchars($keywords, ENT_QUOTES, 'UTF-8') . '</em>';
$__output .= '

';
$__extraData['navigation'] = array();
$__extraData['navigation'][] = array('href' => XenForo_Template_Helper_Core::link('full:wiki/special/search', false, array()), 'value' => 'Tìm kiếm');
$__output .= '
...
'2' => 'highlight'
				...
				<div class="meta">' . 'Lần sửa cuối' . ': ' . XenForo_Template_Helper_Core::callHelper('datetimehtml', array($result['page_date'],array(
