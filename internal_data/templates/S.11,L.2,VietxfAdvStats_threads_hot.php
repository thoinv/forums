...
$__output .= '<div class="VietXfAdvStats_SectionItem VietXfAdvStats_Thread">
...
$__output .= '
	...
	<div class="VietXfAdvStats_SectionItemBlock VietXfAdvStats_SectionItemInfo VietXfAdvStats_ThreadViewCount">
		' . XenForo_Template_Helper_Core::numberFormat($thread['view_count'], '0') . '
		' . (($thread['view_count'] == 1) ? ('view') : ('views')) . '
	</div>
</div>';
