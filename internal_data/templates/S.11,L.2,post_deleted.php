...
$__compilerVar30 = '';
$__compilerVar31 = '';
$__compilerVar31 .= 'post-' . htmlspecialchars($post['post_id'], ENT_QUOTES, 'UTF-8');
$__compilerVar32 = '';
$__compilerVar32 .= XenForo_Template_Helper_Core::link('posts/likes', $post, array());
$__compilerVar33 = '';
if ($post['attachments'])
{
$__compilerVar34 = '';
...
$__compilerVar35 .= '
					...
					';
$__compilerVar34 .= $this->callTemplateHook('attached_file_thumbnail', $__compilerVar35, array(
...
{
$__compilerVar36 .= '<input type="checkbox" name="posts[]" value="' . htmlspecialchars($post['post_id'], ENT_QUOTES, 'UTF-8') . '" class="InlineModCheck item" data-target="#post-' . htmlspecialchars($post['post_id'], ENT_QUOTES, 'UTF-8') . '" title="' . 'Chọn chủ đề này gửi bởi ' . htmlspecialchars($post['username'], ENT_QUOTES, 'UTF-8') . '' . '" />';
}
$__compilerVar36 .= '
...
{
$__compilerVar37 .= '<a href="' . XenForo_Template_Helper_Core::link('posts/history', $post, array()) . '" class="item control history ToggleTrigger"><span></span>' . 'Lịch sử' . '</a>';
}
$__compilerVar37 .= '
				';
if ($post['canDelete'])
{
$__compilerVar37 .= '<a href="' . XenForo_Template_Helper_Core::link('posts/delete', $post, array()) . '" class="item control delete OverlayTrigger"><span></span>' . 'Xóa' . '</a>';
}
$__compilerVar37 .= '
				';
if ($post['canCleanSpam'])
{
$__compilerVar37 .= '<a href="' . XenForo_Template_Helper_Core::link('spam-cleaner', $post, array()) . '" class="item control deleteSpam OverlayTrigger"><span></span>' . 'Spam' . '</a>';
}
$__compilerVar37 .= '
				';
if ($canViewIps AND $post['ip_id'])
{
$__compilerVar37 .= '<a href="' . XenForo_Template_Helper_Core::link('posts/ip', $post, array()) . '" class="item control ip OverlayTrigger"><span></span>' . 'IP' . '</a>';
}
$__compilerVar37 .= '
...
$__compilerVar37 .= '
				...
				';
$__compilerVar36 .= $this->callTemplateHook('post_private_controls', $__compilerVar37, array(
'post' => $post
));
...
{
$__compilerVar38 .= '<a href="' . XenForo_Template_Helper_Core::link('threads/reply', $thread, array(
'quote' => $post['post_id']
)) . '"
...
$__compilerVar38 .= '
				';
$__compilerVar36 .= $this->callTemplateHook('post_public_controls', $__compilerVar38, array(
'post' => $post
));
...
<li id="' . htmlspecialchars($__compilerVar31, ENT_QUOTES, 'UTF-8') . '" class="message ' . (($post['isDeleted']) ? ('deleted') : ('')) . ' ' . (($post['is_staff']) ? ('staff') : ('')) . ' ' . (($post['isIgnored']) ? ('ignored') : ('')) . '" data-author="' . htmlspecialchars($post['username'], ENT_QUOTES, 'UTF-8') . '">
...
unset($__compilerVar31, $__compilerVar32, $__compilerVar33, $__compilerVar36, $__compilerVar39);
