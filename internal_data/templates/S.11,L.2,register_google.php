...
$__extraData['title'] = '';
$__extraData['title'] .= 'Sign up with Google';
$__output .= '
	
<form action="' . XenForo_Template_Helper_Core::link('register/google/register', false, array()) . '" method="post" class="xenForm AutoValidator"
...
$__output .= '
	<li>
		...
		<dl class="ctrlUnit">
			...
			<dd>' . htmlspecialchars($credentials['basic']['email'], ENT_QUOTES, 'UTF-8') . '</dd>
		</dl>
...
$__output .= '
		...
		';
if ($xenOptions['registrationSetup']['requireLocation'] AND !$credentials['user']['currentLocation'])
{
$__output .= '
			<dl class="ctrlUnit">
				<dt>
