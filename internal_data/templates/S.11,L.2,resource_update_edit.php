...
<form action="' . XenForo_Template_Helper_Core::link('resources/save-update', $resource, array()) . '" method="post" class="xenForm AutoValidator" data-redirect="yes">

	<fieldset>
		<dl class="ctrlUnit">
			<dt><label for="ctrl_title">' . 'Tiêu đề' . ':</label></dt>
			<dd>
				<input type="text" name="title" value="' . htmlspecialchars($update['title'], ENT_QUOTES, 'UTF-8') . '" class="textCtrl" data-liveTitleTemplate="' . 'Edit Resource Update' . ': <em>%s</em>" id="ctrl_title" maxlength="100" />
			</dd>
		</dl>
...
$__output .= '
	...
	<input type="hidden" name="resource_update_id" value="' . htmlspecialchars($update['resource_update_id'], ENT_QUOTES, 'UTF-8') . '" />
