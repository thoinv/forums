...
$__extraData['title'] = '';
$__extraData['title'] .= 'Delete Resource: ' . XenForo_Template_Helper_Core::callHelper('resourcePrefix', array(
'0' => $resource,
'1' => 'escaped'
)) . htmlspecialchars($resource['title'], ENT_QUOTES, 'UTF-8') . ' - Version ' . htmlspecialchars($version['version_string'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('resources/delete-version', $resource, array(
'resource_version_id' => $version['resource_version_id']
)) . '" method="post" class="xenForm formOverlay">

	<p>' . 'Are you sure you want to delete version ' . '<strong>' . htmlspecialchars($version['version_string'], ENT_QUOTES, 'UTF-8') . '</strong>' . ' of ' . '<strong>' . XenForo_Template_Helper_Core::callHelper('resourcePrefix', array(
'0' => $resource,
'1' => 'escaped'
...
$__output .= '
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Delete Version' . '" class="button primary" /></dd>
	</dl>
