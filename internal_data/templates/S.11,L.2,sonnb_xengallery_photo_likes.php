...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Members who liked photo id: ' . htmlspecialchars($content['content_id'], ENT_QUOTES, 'UTF-8') . ' in the album "' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '"';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Members who liked photo id: ' . htmlspecialchars($content['content_id'], ENT_QUOTES, 'UTF-8') . ' in the album "' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '"';
$__output .= '
