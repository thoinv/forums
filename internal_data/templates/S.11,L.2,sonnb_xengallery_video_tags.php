...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Members Who Were Tagged In This Video';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Members Who Were Tagged In This Video';
$__output .= '
...
<div class="section">
	<dl class="subHeading pairsInline"><dt>' . 'Video' . ':</dt> <dd><a href="' . XenForo_Template_Helper_Core::link('gallery/videos', $content, array()) . '">' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . '</a></dd></dl>
