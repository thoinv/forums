						...
						<ul id="ctrl_recur_Disabler">
							<li>
								...
								<select name="event_recur_units" class="textCtrl autoSize">
									<option value="days" ' . (($input['event_recur_units'] == ('days')) ? ' selected="selected"' : '') . '>' . 'Days' . '</option>
									<option value="weeks" ' . (($input['event_recur_units'] == ('weeks')) ? ' selected="selected"' : '') . '>' . 'Weeks' . '</option>
									<option value="months" ' . (($input['event_recur_units'] == ('months')) ? ' selected="selected"' : '') . '>' . 'Months' . '</option>
								</select>
								&nbsp;&nbsp;&nbsp;
								';
