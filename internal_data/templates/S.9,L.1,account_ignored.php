...
$__extraData['title'] = '';
$__extraData['title'] .= 'People You Ignore';
$__output .= '
...
$__compilerVar1 .= '
	...
	';
$__output .= $this->callTemplateHook('account_ignored_memberlist', $__compilerVar1, array());
...
$__compilerVar8 .= '
	<dl class="ctrlUnit">
		<dt><label for="ctrl_users">' . 'Member to Ignore' . ':</label></dt>
		<dd>
	...
	';
$__output .= $this->callTemplateHook('account_ignored_controls', $__compilerVar8, array());
