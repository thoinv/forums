...
$__compilerVar1 .= '<a href="http://techlife.com.vn" class="concealed">Diễn đàn đang hoạt động thử nghiệm và chờ giấy phép của bộ <span>&copy;2014-2015 TechLife Forums.</span></a>' . '
            ';
...
if ($page_time)
{
$__compilerVar2 .= '<dt>' . 'Timing' . ':</dt> <dd><a href="' . htmlspecialchars($debug_url, ENT_QUOTES, 'UTF-8') . '" rel="nofollow">' . '' . XenForo_Template_Helper_Core::numberFormat($page_time, '4') . ' seconds' . '</a></dd>';
}
$__compilerVar2 .= '
						';
if ($memory_usage)
{
$__compilerVar2 .= '<dt>' . 'Memory' . ':</dt> <dd>' . '' . XenForo_Template_Helper_Core::numberFormat(($memory_usage / 1024 / 1024), '3') . ' MB' . '</dd>';
}
$__compilerVar2 .= '
						';
if ($db_queries)
{
$__compilerVar2 .= '<dt>' . 'DB Queries' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($db_queries, '0') . '</dd>';
}
$__compilerVar2 .= '
					';
