...
$__output .= '
	...
	<div class="sectionFooter">' . 'Matched ' . XenForo_Template_Helper_Core::numberFormat(count($users), '0') . ' users.' . ' <input type="button" class="button OverlayCloser" value="' . 'Close' . '" /></div>
</div>';
