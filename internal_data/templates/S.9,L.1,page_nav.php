...
'page' => $pageNumberSentinel
	...
	<span class="pageNavHeader">' . 'Page ' . htmlspecialchars($currentPage, ENT_QUOTES, 'UTF-8') . ' of ' . htmlspecialchars($pageTotal, ENT_QUOTES, 'UTF-8') . '' . '</span>
...
{
$__output .= '
		<a href="' . $unreadLinkHtml . '" class="text distinct unreadLink">' . 'Go to First Unread' . '</a>
	';
}
$__output .= '
</div>
...
{
$__output .= '
<div class="PageNav"><a href="' . $unreadLinkHtml . '" class="text unreadLink">' . 'Go to First Unread' . '</a></div>
';
}
