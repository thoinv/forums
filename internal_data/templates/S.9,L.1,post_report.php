...
'0' => $thread,
'1' => 'escaped'
)) . htmlspecialchars($thread['title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Report Post';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Report Post';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('posts/report', $post, array()) . '" method="post" class="xenForm formOverlay AutoValidator">
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Report Post' . '" accesskey="s" class="button primary" /></dd>
	</dl>
