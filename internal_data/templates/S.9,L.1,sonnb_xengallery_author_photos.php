...
$__extraData['title'] = '';
$__extraData['title'] .= '' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . '\'s photos' . ' ' . XenForo_Template_Helper_Core::callHelper('pagenumber', array(
'0' => $page
));
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= '' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . '\'s photos';
$__output .= '
';
$__extraData['pageDescription'] = array();
$__extraData['pageDescription']['content'] = '';
$__extraData['pageDescription']['content'] .= 'All photos that ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' has uploaded to gallery at ' . htmlspecialchars($xenOptions['boardTitle'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '

';
$__extraData['head']['canonical'] = '';
$__extraData['head']['canonical'] .= '
	<link rel="canonical" href="' . XenForo_Template_Helper_Core::link('canonical:gallery/authors/photos', $user, array(
'page' => $page
)) . '" />
...
$__output .= '
	<div class="subnav-holder">
		<ul class="tabs mainTabs">
			...
			<li class="active"><a href="' . htmlspecialchars($requestPaths['requestUri'], ENT_QUOTES, 'UTF-8') . '#">' . 'Photos' . '</a></li>
...
$__compilerVar3 .= '
			';
$__output .= $this->callTemplateHook('author_photo_list', $__compilerVar3, array());
...
<div class="pageNavLinkGroup xengallery">
	' . XenForo_Template_Helper_Core::callHelper('pagenavhtml', array('public', htmlspecialchars($photosPerPage, ENT_QUOTES, 'UTF-8'), htmlspecialchars($totalPhotos, ENT_QUOTES, 'UTF-8'), htmlspecialchars($page, ENT_QUOTES, 'UTF-8'), 'gallery/authors/photos', $user, $pageNavParams, false, array())) . '
</div>
';
$__compilerVar13 = '';
