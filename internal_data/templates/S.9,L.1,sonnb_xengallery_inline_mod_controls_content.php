...
$__compilerVar1 = '';
$__compilerVar1 .= 'InlineModControlsContent';
$__compilerVar2 = '';
$__compilerVar2 .= 'ModerationSelectContent';
$__compilerVar3 = '';
$__compilerVar3 .= 'Content Moderation';
$__compilerVar4 = '';
$__compilerVar4 .= '
		';
if ($inlineModOptions['delete'])
{
$__compilerVar4 .= '<option value="delete">' . 'Delete Contents' . '...</option>';
}
$__compilerVar4 .= '
		';
if ($inlineModOptions['undelete'])
{
$__compilerVar4 .= '<option value="undelete">' . 'Undelete Contents' . '</option>';
}
$__compilerVar4 .= '
		';
if ($inlineModOptions['approve'])
{
$__compilerVar4 .= '<option value="approve">' . 'Approve Contents' . '</option>';
}
$__compilerVar4 .= '
		';
if ($inlineModOptions['unapprove'])
{
$__compilerVar4 .= '<option value="unapprove">' . 'Unapprove Contents' . '</option>';
}
$__compilerVar4 .= '
		';
if ($inlineModOptions['move'])
{
$__compilerVar4 .= '<option value="move">' . 'Move Contents' . '...</option>';
}
$__compilerVar4 .= '
		<option value="deselect">' . 'Deselect Contents' . '</option>
	';
$__compilerVar5 = '';
$__compilerVar5 .= 'sonnb_xengallery_select_deselect_all_loaded_contents';
$__compilerVar6 = '';
$__compilerVar6 .= 'Contents';
$__compilerVar7 = '';
