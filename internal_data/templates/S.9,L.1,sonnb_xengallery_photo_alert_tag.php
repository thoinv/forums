...
'0' => $user,
'1' => 'subject'
)) . ' tagged you in the photo ' . '<a href="' . XenForo_Template_Helper_Core::link('gallery/photos', $content, array()) . '" class="PopupItemLink">' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . '</a>' . ' in the album ' . '<a href="' . XenForo_Template_Helper_Core::link('gallery/albums', $content['album'], array()) . '" class="PopupItemLink">' . htmlspecialchars($content['album']['title'], ENT_QUOTES, 'UTF-8') . '</a>' . '. Click to ' . '<a href="' . XenForo_Template_Helper_Core::link('gallery/tags/accept', $content, array(
