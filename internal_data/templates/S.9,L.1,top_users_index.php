...
'0' => $user
							...
							<dl class="userStats pairsInline">
								<dt title="' . 'Total messages posted by ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . '' . '">' . htmlspecialchars($topUsers['month_str'], ENT_QUOTES, 'UTF-8') . ': ' . 'Messages' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($user['messages_delta'], '0') . '</dd>
								<dt title="' . 'Number of times something posted by ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' has been \'liked\'' . '">' . 'Likes Received' . ':</dt> <dd>' . XenForo_Template_Helper_Core::numberFormat($user['likes_delta'], '0') . '</dd>
