...
{
$__output .= '
			<div class="sectionFooter"><a href="' . XenForo_Template_Helper_Core::link('members/friends', $user, array()) . '" class="OverlayTrigger">' . 'Show All' . '</a></div>
		';
}
$__output .= '
	</div>
...
{
$__output .= '
			<div class="sectionFooter"><a href="' . XenForo_Template_Helper_Core::link('members/mutual-friends', $user, array()) . '" class="OverlayTrigger">' . 'Show All' . '</a></div>
		';
}
$__output .= '
	</div>
