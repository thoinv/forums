...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($event['event_title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($event['event_title'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
...
<div class="sectionMain">
	<form action="' . XenForo_Template_Helper_Core::link('events/edit', $event, array()) . '" method="post" class="xenForm AutoValidator" data-redirect="true">
		<fieldset>
			';
$__compilerVar6 = '';
$__compilerVar6 .= htmlspecialchars($thread['prefix_id'], ENT_QUOTES, 'UTF-8');
$__compilerVar7 = '';
$__compilerVar7 .= 'event_edit';
$__compilerVar8 = '';
	...
	<dl class="ctrlUnit" id="PrefixContainer_' . htmlspecialchars($__compilerVar7, ENT_QUOTES, 'UTF-8') . '">
		...
		<dd>
			<select name="prefix_id" id="ctrl_prefix_id_' . htmlspecialchars($__compilerVar7, ENT_QUOTES, 'UTF-8') . '" class="textCtrl TitlePrefix"
				...
				';
$__compilerVar9 = '';
$__compilerVar9 .= '<option value="0" data-css="prefix noPrefix" ' . (($__compilerVar6 == 0) ? ' selected="selected"' : '') . '>(' . 'Không tiền tố' . ')</option>
';
						...
						<ul id="ctrl_recur_Disabler">
							<li>
								...
								<select name="event_recur_units" class="textCtrl autoSize">
									<option value="days" ' . (($event['event_recur_units'] == ('days')) ? ' selected="selected"' : '') . '>' . 'Ngày' . '</option>
									<option value="weeks" ' . (($event['event_recur_units'] == ('weeks')) ? ' selected="selected"' : '') . '>' . 'Tuần' . '</option>
									<option value="months" ' . (($event['event_recur_units'] == ('months')) ? ' selected="selected"' : '') . '>' . 'Tháng' . '</option>
								</select>
								&nbsp;&nbsp;&nbsp;
								';
