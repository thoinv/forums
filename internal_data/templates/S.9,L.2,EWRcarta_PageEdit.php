...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($page['page_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($page['page_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
...
$__output .= '
			...
			<dl class="ctrlUnit">
				...
				<dd><input type="search" name="administrators" placeholder="' . 'Tên' . '..." value="' . htmlspecialchars($page['page_admins'], ENT_QUOTES, 'UTF-8') . '" results="0" class="textCtrl AutoComplete" />
			...
			<fieldset>
				<dl class="ctrlUnit">
					...
					<dd><input type="search" name="usernames" placeholder="' . 'Tên' . '..." value="' . htmlspecialchars($page['page_users'], ENT_QUOTES, 'UTF-8') . '" results="0" class="textCtrl AutoComplete" /></dd>
				</dl>
...
$__output .= '
					 ...
					 &nbsp; &nbsp; 
					<input type="submit" value="' . 'Đăng chủ đề' . '" name="submit" accesskey="s" class="button primary" />
				';
}
$__output .= '
			</dd>
