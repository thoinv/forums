...
$__extraData['title'] = '';
$__extraData['title'] .= htmlspecialchars($category['category_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= htmlspecialchars($category['category_name'], ENT_QUOTES, 'UTF-8') . ' - ' . 'Sửa';
$__output .= '
