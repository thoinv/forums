...
$__extraData['title'] = '';
$__extraData['title'] .= 'Danh sách đen';
$__output .= '
...
<form method="post" class="xenForm AutoValidator FollowForm"
	action="' . XenForo_Template_Helper_Core::link('account/ignore', false, array()) . '"
...
$__compilerVar9 .= '
	...
	';
$__output .= $this->callTemplateHook('account_ignored_memberlist', $__compilerVar9, array());
...
$__compilerVar16 .= '
	<dl class="ctrlUnit">
		<dt><label for="ctrl_users">' . 'Thêm thành viên vào danh sách đen' . ':</label></dt>
		<dd>
	...
	';
$__output .= $this->callTemplateHook('account_ignored_controls', $__compilerVar16, array());
