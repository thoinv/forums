...
$__extraData['title'] = '';
$__extraData['title'] .= 'Ra khỏi đối thoại này' . ': ' . htmlspecialchars($conversation['title'], ENT_QUOTES, 'UTF-8');
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('conversations/leave', $conversation, array()) . '" method="post" class="xenForm formOverlay">
	...
	<dl class="ctrlUnit submitUnit">
		<dt></dt>
		<dd><input type="submit" value="' . 'Ra khỏi đối thoại này' . '" accesskey="s" class="button primary" /></dd>
	</dl>
