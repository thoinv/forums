...
$__extraData['title'] = '';
$__extraData['title'] .= 'Thành viên ' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' đang theo dõi';
$__output .= '
...
{
$__output .= '
			' . '' . htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8') . ' không theo dõi ai.' . '
		';
}
$__output .= '
	</div>
