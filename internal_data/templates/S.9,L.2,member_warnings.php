...
<tr class="dataRow">
	...
	<th class="warningPoints">' . 'Điểm' . '</th>
...
$__output .= '</td>
		<td class="warningView dataOptions"><a href="' . XenForo_Template_Helper_Core::link('warnings', $warning, array()) . '" class="OverlayTrigger secondaryContent">' . 'Xem' . '</a></td>
	</tr>
';
}
$__output .= '
