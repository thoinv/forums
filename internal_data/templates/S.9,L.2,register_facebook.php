...
$__extraData['title'] = '';
$__extraData['title'] .= 'Đăng ký bằng tài khoản Facebook';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('register/facebook/register', false, array()) . '" method="post" class="xenForm AutoValidator"
...
$__output .= '
	<li>
		...
		<dl class="ctrlUnit">
			...
			<dd>' . htmlspecialchars($fbUser['email'], ENT_QUOTES, 'UTF-8') . '</dd>
		</dl>
...
$__output .= '
		...
		';
if ($xenOptions['registrationSetup']['requireLocation'] AND !$fbUser['location']['name'])
{
$__output .= '
			<dl class="ctrlUnit">
				<dt>
...
{
$__output .= '
						<p class="explain">' . 'This member matches the email address associated with your external account.' . '</p>
					';
}
$__output .= '
...
<input type="hidden" name="fb_token" value="' . htmlspecialchars($fbToken, ENT_QUOTES, 'UTF-8') . '" />
</form>';
