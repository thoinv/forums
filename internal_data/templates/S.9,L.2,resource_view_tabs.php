...
{
$__compilerVar2 .= '<li class="resourceTabUpdates ' . (($selectedTab == ('updates')) ? ('active') : ('')) . '">
...
{
$__compilerVar2 .= '<li class="resourceTabReviews ' . (($selectedTab == ('reviews')) ? ('active') : ('')) . '">
...
{
$__compilerVar2 .= '<li class="resourceTabHistory ' . (($selectedTab == ('history')) ? ('active') : ('')) . '">
...
if ($thread)
{
$__compilerVar2 .= '<li class="resourceTabDiscussion ' . (($selectedTab == ('discussion')) ? ('active') : ('')) . '">
			<a href="' . XenForo_Template_Helper_Core::link('threads', $thread, array()) . '">' . 'Discussion' . '</a>
		</li>';
}
$__compilerVar2 .= '
	';
$__output .= $this->callTemplateHook('resource_view_tabs', $__compilerVar2, array());
