...
';
$__compilerVar7 = '';
$__output .= $this->callTemplateHook('ad_author_view_above_album_list', $__compilerVar7, array());
...
{
$__compilerVar9 .= htmlspecialchars($album['photo_count'], ENT_QUOTES, 'UTF-8') . ' ' . 'photos';
}
if ($album['video_count'])
{
$__compilerVar9 .= (($album['photo_count']) ? (' - ') : ('')) . htmlspecialchars($album['video_count'], ENT_QUOTES, 'UTF-8') . ' ' . 'videos';
}
$__compilerVar9 .= '
		</div>
		<div class="userInfo">
...
$__compilerVar8 .= '
		';
$__output .= $this->callTemplateHook('author_album_list', $__compilerVar8, array());
