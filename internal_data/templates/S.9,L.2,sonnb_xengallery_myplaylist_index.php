...
$__compilerVar3 .= '1';
$__compilerVar4 = '';
$__compilerVar4 .= '<li class="playlistListItem" id="playlist-' . htmlspecialchars($playlist['playlist_id'], ENT_QUOTES, 'UTF-8') . '">
...
if ($__compilerVar3)
{
$__compilerVar4 .= '<input type="checkbox" name="playlist_ids[]" value="' . htmlspecialchars($playlist['playlist_id'], ENT_QUOTES, 'UTF-8') . '" autocomplete="off" /> ';
}
$__compilerVar4 .= '<a
...
'time' => htmlspecialchars($playlist['added_date'], ENT_QUOTES, 'UTF-8')
				...
				<a href="' . XenForo_Template_Helper_Core::link('gallery/my-playlists/delete', $playlist, array()) . '" class="OverlayTrigger item delete">' . 'Xóa' . '</a>
				<a href="' . XenForo_Template_Helper_Core::link('gallery/my-playlists/edit', $playlist, array()) . '" class="OverlayTrigger item edit">' . 'Sửa' . '</a>
			</div>
			<div class="tagLine">
