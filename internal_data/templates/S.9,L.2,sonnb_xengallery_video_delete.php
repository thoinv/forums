...
$__extraData['title'] = '';
$__extraData['title'] .= 'Delete video ' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . ' in the album ' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
';
$__extraData['h1'] = '';
$__extraData['h1'] .= 'Delete video ' . htmlspecialchars($content['title'], ENT_QUOTES, 'UTF-8') . ' in the album ' . htmlspecialchars($album['title'], ENT_QUOTES, 'UTF-8') . '';
$__output .= '
...
<form action="' . XenForo_Template_Helper_Core::link('gallery/videos/delete', $content, array()) . '" method="post" class="xenForm formOverlay AutoValidator" data-redirect="on" >

	';
if ($canHardDelete)
{
$__output .= '<p class="hint">' . 'By selecting "Permanently delete" option, all the comments, likes, tags... belong to this video would be deleted permanently and unrecoverable. Please consider before you do this.' . '</p>';
}
$__output .= '
...
$__output .= '
			<input type="submit" value="' . 'Delete Video' . '" class="button primary" />
		</dd>
	</dl>
