...
$__output .= '
	...
	<div class="sectionFooter">
		' . 'Tổng số phiếu ' . XenForo_Template_Helper_Core::numberFormat(count($response['voters']), '0') . '.' . '
		<input type="button" class="button OverlayCloser overlayOnly" value="' . 'Đóng' . '" />
	</div>
</div>';
