    ...
    XenForo.InlineModForm.prototype =
    {
        __construct: function($form)
        {
            ...
            var $controls = $(this.$form.data('controls')),
                ...
                $overlayId = this.$form.data('overlayid'),
                $countContainer = $('.SelectionCountContainer');

            if (!$overlayId)
            {
                $overlayId = 'InlineModOverlay';
            }

            $controls.show().appendTo('body').wrap('<form class="InlineModOverlay" id="'+$overlayId+'" />');
        ...
        {
            var $overlayId = this.$form.data('overlayid'),
                $ModerationSelectControl = this.$form.data('imodoptions');
            ...
            var $InlineModOverlay = $('#'+$overlayId),
                $ModerationSelect = $InlineModOverlay.find($ModerationSelectControl);
