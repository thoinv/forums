	...
	public function renderJson()
	{
		...
		if(!empty($this->_params['tabParams']) && !empty($this->_params['modernStatistic']) && isset($this->_params['tabId'])){
			...
			if(!empty($modernStatistic['enable_cache']) && !empty($modernStatistic['cache_time'])){
				...
				$modernModel->saveCacheForStatistic($modernStatistic['modern_statistic_id'], $userId, $cachedStatistic['cache_html'], $cachedStatistic['cache_params'], $cachedStatistic['tabCacheHtmls'], $cachedStatistic['tabCacheParams']);
			}
