...
class EWRporta_Option_RecentFeatures
{
	...
	public static function verifyWidth(&$option, XenForo_DataWriter $dw, $fieldName)
	{
		$templateModel = XenForo_Model::create('XenForo_Model_Template');
		...
		$data['template'] = preg_replace('#{.*?/\*WIDTH\*/#i', '{ width: '.$option.'px; } /*WIDTH*/', $data['template']);
