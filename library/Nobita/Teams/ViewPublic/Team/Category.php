...
class Nobita_Teams_ViewPublic_Team_Category extends XenForo_ViewPublic_Base
{
	public function renderHtml()
	{
		...
		$parentIds[] = 0;
		array_unshift($parentIds, $this->_params['category']['team_category_id']);
		$lastParentId = $this->_params['category']['team_category_id'];
		...
		foreach ($parentIds AS $parentId)
		{
			...
			$categorySidebarHtml = $this->_renderer->createTemplateObject('Team_category_sidebar_list', array(
