<?php
class Sedo_AgentTracer_Datawriter_ConversationMessage extends XFCP_Sedo_AgentTracer_Datawriter_ConversationMessage
{
	protected function _getFields()
	{
		$fields = parent::_getFields();
		$fields['xf_conversation_message']['sedo_agent'] = array('type' => self::TYPE_STRING, 'default' => '');
