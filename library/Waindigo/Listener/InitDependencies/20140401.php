...
class Waindigo_Listener_InitDependencies
{
    ...
    public static function copyrightNotice(array $matches)
    {
        ...
        return $matches[0] . '
            ...
            '<div id="waindigoCopyrightNotice"><a href="https://waindigo.com" class="concealed">' .
            'XenForo add-ons by Waindigo&trade;</a> <span>&copy;2014 <a href="https://waindigo.com" class="concealed">' .
