...
class Waindigo_Listener_InitDependencies
{
    ...
    public static function copyrightNotice(array $matches)
    {
        ...
        return $matches[0] . '
            ...
            '<xen:include template="waindigo_copyright_notice_installupgrade" />' .
            '<xen:else />' .
            '<div id="waindigoCopyrightNotice"><a href="https://waindigo.org" class="concealed">' .
            'XenForo add-ons by Waindigo&trade;</a> <span>&copy; ' . self::getCopyrightYear() . '<a href="https://waindigo.org" class="concealed">' .
            'Waindigo Foundation</a>.</span></div>' .
            '</xen:if>' .
            '</xen:if>';
    } /* END copyrightNotice */
