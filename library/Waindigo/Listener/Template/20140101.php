...
abstract class Waindigo_Listener_Template
{
    ...
    protected static $copyrightNotice = '<div id="waindigoCopyrightNotice" class="footerLegal" style="clear:both"><div class="pageContent"><span class="muted">Certain <a href="http://www.waindigo.com/" class="concealed">XenForo add-ons by Waindigo</a>&trade; &copy;2011-2014 <a href="http://waindigo.com" class="concealed">Waindigo Enterprises Ltd</a>.</span></div></div>';
    ...
    protected function _indentContent($content, $tab = "\t")
    {
        ...
        while ($token !== false) {
            ...
            } else if (!$textarea && preg_match('/^<(\w+)(.*)>.*$/', $token, $matches)) {
    ...
    } /* END _appendTemplateBeforeDomQuery */
    ...
    } /* END _appendTemplateAfterDomQuery */
    ...
    } /* END _appendTemplateAtCodeSnippet */
    ...
    } /* END _appendTemplateBeforeCodeSnippet */
    ...
    } /* END _appendTemplateAfterCodeSnippet */
    ...
    protected function _replaceCallbackAtDomQuery($query, $callback, &$contents = null, $extraData = null)
    {
        ...
        return false;
    } /* END _replaceCallbackAtDomQuery */
    ...
    } /* END _replaceWithTemplateAtCodeSnippet */
     ...
     * number of replacements done.
     */
    protected function _appendTemplateAtPattern($pattern, $templateName, array $viewParams = null, &$contents = null, $limit = 1, &$count = 0)
    {
     ...
     * number of replacements done.
     */
    protected function _prependTemplateAtPattern($pattern, $templateName, array $viewParams = null, &$contents = null, $limit = 1, &$count = 0)
    {
        $replacement = $this->_escapeDollars($this->_render($templateName, $viewParams)) . '${0}';
        return $this->_patternReplace($pattern, $replacement, $contents, $limit, $count);
    } /* END _prependTemplateAtPattern */
     ...
     * number of replacements done.
     */
    protected function _replaceWithTemplateAtPattern($pattern, $templateName, array $viewParams = null, &$contents = null, $limit = 1, &$count = 0)
    {
        $replacement = $this->_escapeDollars($this->_render($templateName, $viewParams));
        return $this->_patternReplace($pattern, $replacement, $contents, $limit, $count);
    } /* END _replaceWithTemplateAtPattern */
