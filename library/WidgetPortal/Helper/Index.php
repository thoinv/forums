<?php
/**
 * @title Widget Portal Helper Index
 ...
 */
class WidgetPortal_Helper_Index
{
    /**
    ...
    protected static function _setCustomRoutePrefixes( $defaultRoutePrefix, array $routesPublic )
    {
        $routesPublic['index'] = array(
            'build_link' => 'all',
            'route_class' => 'WidgetPortal_Route_PrefixPublic_Index'
        );

        $routesPublic['forum'] = array(
            'build_link' => 'none',
            'route_class' => 'WidgetPortal_Route_PrefixPublic_Forum'
        );
    ...
    public static function loadClassRoutePrefix( $class, array &$extend )
    {
        switch ( $class )
        {
            case XenForo_Application::get( 'customIndex' )->routeClass:
                ...
                $extend[] = 'WidgetPortal_Route_PrefixPublic_Custom';
                break;
