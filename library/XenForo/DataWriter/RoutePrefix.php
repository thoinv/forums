...
class XenForo_DataWriter_RoutePrefix extends XenForo_DataWriter
{
	...
	*/
	...
	protected function _preSave()
	{
		...
		if ($this->isChanged('route_class') && !class_exists($this->get('route_class')))
		{
			$this->error(new XenForo_Phrase('invalid_class_x', array('class' => $this->get('route_class'))), 'route_class');
		}
	}
