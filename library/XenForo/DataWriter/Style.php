...
class XenForo_DataWriter_Style extends XenForo_DataWriter
{
	...
	*/
	...
	protected function _preSave()
	{
		...
		{
			$this->set('last_modified_date', time());
		}
	}
	...
	protected function _postDelete()
	{
		...
		{
			XenForo_Template_FileHandler::delete(null, $styleId, null);
		}
		$db->delete('xf_style_property', 'style_id = ' . $styleIdQuoted);
		$db->delete('xf_style_property_definition', 'definition_style_id = ' . $styleIdQuoted);
		$db->delete('xf_style_property_group', 'group_style_id = ' . $styleIdQuoted);
