...
class XenForo_Model_FloodCheck extends XenForo_Model
{
	 ...
	 *
	 * @param integer|null $age Minimum age (in seconds) of data that will be pruned.
	 */
	public function pruneFloodCheckData($age = null)
	{
		if ($age === null)
		{
			$age = XenForo_Application::get('options')->floodCheckLength;
		}
