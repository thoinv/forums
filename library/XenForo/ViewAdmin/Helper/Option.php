...
class XenForo_ViewAdmin_Helper_Option
{
	...
	public static function renderPreparedOptionHtml(XenForo_View $view, array $preparedOption, $canEdit, $fieldPrefix = 'options')
	{
		switch ($preparedOption['edit_format'])
		{
			...
			case 'onofftextbox':  $callbackMethod = '_renderOnOffTextBoxOptionHtml'; break;
	...
	{
		return self::renderOptionTemplateInternal('option_list_option_onoff_textbox',
			$view, $fieldPrefix, $preparedOption, $canEdit
		);
	}
	 ...
	 * @return XenForo_Template_Abstract Template object
	 */
	public static function renderOptionTemplateInternal($template, XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit, array $extra = array())
	{
