...
class bdSocialShare_Crypt
{
	public static function encrypt($data, $key)
	{
		return base64_encode(self::aes128_encrypt($data, $key . XenForo_Application::getConfig()->get('globalSalt')));
	}

	public static function decrypt($data, $key)
	{
		return self::aes128_decrypt(base64_decode($data), $key . XenForo_Application::getConfig()->get('globalSalt'));
	}
