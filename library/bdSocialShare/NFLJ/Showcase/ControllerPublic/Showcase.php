...
class bdSocialShare_NFLJ_Showcase_ControllerPublic_Showcase extends XFCP_bdSocialShare_NFLJ_Showcase_ControllerPublic_Showcase
{
	// Showcase add-on switched from using NFLJ_Showcase_ControllerPublic_Index
	// to NFLJ_Showcase_ControllerPublic_Showcase, the code below is basically the
	// same as bdSocialShare_NFLJ_Showcase_ControllerPublic_Index
	...
	{
		if ($itemDw->get('item_state') != 'draft')
		{
