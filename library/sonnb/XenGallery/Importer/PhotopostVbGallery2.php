 ...
 */
class sonnb_XenGallery_Importer_PhotopostVbGallery2 extends sonnb_XenGallery_Importer_Abstract
{
	public static function getName()
	{
		return 'PhotoPost vBGallery 2.4.x+ (vB 3.7.x+) => sonnb - XenGallery';
	}
	...
	public function stepPhotos($start, array $options)
	{
		...
		foreach ($images AS $image)
		{
			...
			if ($last <> $next)
			{
				...
				if (!isset(sonnb_XenGallery_Model_ContentData::$typeMap[$image['extension']]))
				{
					continue;
				}
