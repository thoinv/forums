 ...
 */
class sonnb_XenGallery_ModeratorLogHandler_Album extends XenForo_ModeratorLogHandler_Abstract
{
	/**
	 * @param array $logUser
	 * @param array $content
	...
	protected function _log(array $logUser, array $content, $action, array $actionParams = array(), $parentContent = null)
	{
		...
		$dw->bulkSet(array(
			...
			'content_type' => sonnb_XenGallery_Model_Album::$xfContentType,
			...
			'content_url' => XenForo_Link::buildPublicLink('gallery/albums', $content),
			'discussion_content_type' => sonnb_XenGallery_Model_Album::$xfContentType,
	...
	protected function _prepareEntry(array $entry)
	{
		...
		$entry['actionText'] = new XenForo_Phrase(
			'sonnb_xengallery_moderator_log_album_'.$entry['action'],
