 ...
 */
class sonnb_XenGallery_ViewPublic_Comment_DeleteInline extends sonnb_XenGallery_ViewPublic_Abstract
{
	public function renderJson()
	{
		...
		$output['hardDelete'] = $this->_params['hardDelete'];
		$output['phrase'] = $this->_params['phrase'];
